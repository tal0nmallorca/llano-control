...
Las asociaciones están respaldadas por capturas Windows y por las acciones/observaciones del registro. Falta confirmar físicamente los efectos de las órdenes Linux, recuperación desde manual y calibración de los extremos. Las RPM calculadas son estimaciones, no lecturas de tacómetro. El inicio de la aplicación no activa escrituras automáticas: el usuario aplica el perfil explícitamente.
